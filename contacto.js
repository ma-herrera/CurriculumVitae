...
async function handleSubmit(event) {
  ...
  /*
  evitar que se haga el submit antes de ejecutar el javascript para:
  1)hacer la validacion de los campos
  2) evitar que despues del submit quede en la pagina de formspree
  */
  ...
  if (apellido.value.length === 0)
    ...
    validation_status += `El campo "Comentarios" no puede estar vacío<br>`;
  ...
  {
    /* se usa el campo del formulario status para mostrar los mensajes de resultado */
